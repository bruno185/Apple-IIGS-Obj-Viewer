 ...
 *
 * DESCRIPTION:
 *   Wait a specific number of seconds using std::chrono.
 *
 */
    ...
    loopReDraw:
        ...
        switch (key) {
            ...
            case 21:  // Right arrow - increase horizontal angle
                ...
                if (params.angle_h >= INT_TO_FIXED(360)) {
                    params.angle_h = params.angle_h - INT_TO_FIXED(360);
                }
                if (params.angle_h < 0) {
                    params.angle_h = params.angle_h + INT_TO_FIXED(360);
                }
            ...
            case 10:  // Down arrow - decrease vertical angle
                ...
                if (params.angle_v >= INT_TO_FIXED(360)) {
                    params.angle_v = params.angle_v - INT_TO_FIXED(360);
                }
                if (params.angle_v < 0) {
                    params.angle_v = params.angle_v + INT_TO_FIXED(360);
                }
            ...
            case 119: // 'w'
                ...
                goto bigloop;
                if (params.angle_w >= INT_TO_FIXED(360)) {
                    params.angle_w = params.angle_w - INT_TO_FIXED(360);
                }
                if (params.angle_w < 0) {
                    params.angle_w = params.angle_w + INT_TO_FIXED(360);
                }
